        ...
        <html>
            ...
            <body style='min-height: 75rem; padding-top: 3.5rem;'>
                ...
                <table
                    ...
                    <tr>
                        <th>name</th>
                        <th>label</th><th>actionName</th><th>actionType</th><th>inputParameters</th><th>value</th>

                        
                    </tr>
                    <xsl:apply-templates select="sf:Flow/sf:actionCalls" >
    ...
    <xsl:template match="sf:actionCalls">
        <xsl:for-each select=".">
            <tr>
                ...
                <td> <xsl:value-of select="sf:actionName" /> </td>

                <td> <xsl:value-of select="sf:actionType" /> </td>
               <td> <ul>
    <xsl:for-each select="sf:inputParameters">

              <li>  <xsl:value-of select="sf:name" /> :
                 <xsl:value-of select="sf:value" /> </li>
 </xsl:for-each>
</ul>
             </td>
